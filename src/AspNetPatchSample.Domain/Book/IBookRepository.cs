...
namespace AspNetPatchSample.Domain.Book
{
  ...
  public interface IBookRepository : IRepository<IBookEntity>
  {
    ...
    /// <returns>An object that represents an asynchronous operation that produces a result at some time in the future. The result is an instance of the <see cref="Domain.Entity.IBookEntity"/>. The result can be null.</returns>
