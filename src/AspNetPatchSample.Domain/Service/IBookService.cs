...
namespace AspNetPatchSample.Domain.Service
{
  ...
  public interface IBookService
  {
    ...
    public Task<IBookEntity?> GetOrderAsync(IBookIdentity bookIdentity, CancellationToken cancellationToken);
    ...
    public Task<IBookEntity> AddOrderAsync(IBookData bookData, CancellationToken cancellationToken);

    /// <summary>Updates a book.</summary>
    /// <param name="bookEntity">An object that reprents a book entity.</param>
    /// <param name="cancellationToken">An object that propagates notification that operations should be canceled.</param>
    /// <returns>An object that represents an asynchronous operation.</returns>
    public Task UpdateOrderAsync(IBookEntity bookEntity, CancellationToken cancellationToken);
  }
}
