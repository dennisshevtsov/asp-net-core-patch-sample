...
namespace AspNetPatchSample.Domain.Repository
{
  ...
  public interface IBookRepository
  {
    ...
    public Task UpdateAsync(IBookEntity bookEntity, CancellationToken cancellationToken);
    ...
    /// <param name="cancellationToken">An object that propagates notification that operations should be canceled.</param>
    /// <returns>An object that represents an asynchronous operation.</returns>
    public Task UpdateAsync(IBookEntity bookEntity, IPatchable patchable, CancellationToken cancellationToken);
  }
}
