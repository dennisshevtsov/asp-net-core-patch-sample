...
namespace AspNetPatchSample.Infrastructure.Repository
{
    ...
    /// <summary>Provides a simple API to store instances of the <see cref="Domain.Author.IAuthorEntity"/>.</summary>
    public sealed class AuthorRepository : RepositoryBase<IAuthorEntity, AuthorEntity>, IAuthorRepository
  {
    /// <summary>Initializes a new instance of the <see cref="AspNetPatchSample.Infrastructure.Repository.AuthorRepository"/> class.</summary>
    ...
    /// <returns>An object that represents an asynchronous operation that produces a result at some time in the future. The result is an instance of the <see cref="Domain.Author.IAuthorEntity"/>.</returns>
